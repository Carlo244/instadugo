...
class BloodRequestNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->view('emails.blood_notification', [
                ...
                'hospital' => $this->bloodRequest->hospitalAdmin->hospital_name ?? 'Our Partner Hospital'
            ]);
    }
    ...
    {
        return [
            'message' => "Urgent request for {$this->bloodRequest->blood_type} at {$this->bloodRequest->hospitalAdmin->name}",
