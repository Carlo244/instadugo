...
@section('title', 'Blood Ready for Pickup')

@section('content')
    <h2 style="font-size: 22px; margin-bottom: 20px; color: #1a1a1a; text-align: center;">Blood Request Fulfilled</h2>

    <p style="font-size: 16px; line-height: 1.6;">Hello <strong>{{ $user->name }}</strong>,</p>

    <p style="font-size: 16px; line-height: 1.6;">Good news. Your blood request has been
        <strong>successfully fulfilled</strong> and is now ready for pickup/coordination with your assigned hospital.
    </p>

    <div
        style="background-color: #ecfdf3; border-left: 4px solid #16a34a; padding: 20px; margin: 25px 0; border-radius: 0 8px 8px 0;">
        <p
            style="font-size: 14px; color: #166534; text-transform: uppercase; font-weight: 800; margin: 0 0 10px 0; letter-spacing: 0.5px;">
            Status Update:
        </p>
    ...
    <table border="0" cellpadding="15" cellspacing="0" width="100%"
        ...
        <tr>
            <td style="font-size: 14px; line-height: 1.8; color: #4a5568;">
                ...
                • Urgency: <strong>{{ $request->urgency }}</strong><br>
